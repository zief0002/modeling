...
Martin Krzywinski has written a [very readable introduction](http://mkweb.bcgsc.ca/brewer/) to the Brewer color palettes.
...
#| fig-alt: "Okabe Ito colorblind-friendly palette. Colors include #000000, #e69f00, #56b4e9, #009e73, #f0e442, #0072b2, #d55e00, and #cc79a7."
#| echo: false
#| out-width: "100%"

knitr::include_graphics("figs/01-05-okabe-ito-palette.png")
```
...
```{r}
#| label: fig-legend
#| fig-cap: "Customizing the legend with the `labels=` argument in `scale_color_manual()`."
#| fig-alt: "Customizing the legend with the `labels=` argument in `scale_color_manual()`."
#| fig-width: 8
#| fig-height: 6
#| out-width: '80%'
...
#| fig-cap: "You can customize almost any part of the theme using the `theme()` layer. In this plot we changed the font color on the x-axis label and increased the font size of all the text elements in the plot."
#| fig-alt: "You can customize almost any part of the theme using the `theme()` layer. In this plot we changed the font color on the x-axis label and increased the font size of all the text elements in the plot."
#| fig-width: 8
#| fig-height: 6
#| out-width: '80%'
