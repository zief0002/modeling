...
#| fig-alt: "Scatterplot of per person CO2 emissions versus income for 193 countries. This plot is shown for each of the four world regions."
...
#| fig-alt: "Scatterplot of per person CO2 emissions versus income for 193 countries. This plot is shown for each of the four world regions and whether or not CO2 emissions increased or decreased since 2007."
#| fig-width: 4
#| fig-height: 8
#| out-width: '70%'
...
```{r}
#| label: fig-axis
#| fig-cap: "Using xlab() and ylab() to change the labels on the axes."
#| fig-alt: "Using xlab() and ylab() to change the labels on the axes."
...
```{r}
#| label: fig-limits
#| fig-cap: "Using xlim() and ylim() to change the limits on the axes."
#| fig-alt: "Using xlim() and ylim() to change the limits on the axes."
...
#| fig-alt: "Scale on the x-axis set to have a label, as well as, specific limits, and break lines."
...
#| fig-alt: "Color palette set manually using named color values."
...
#| fig-alt: "Color palette set manually using named color values. Colors are assigned to specific regions by naming them in the `scale_fill_manula()` layer."
#| fig-width: 8
#| fig-height: 6
#| out-width: '70%'
...
#| fig-alt: "Color palette set manually using RGB triplets."
#| fig-width: 8
#| fig-height: 6
#| out-width: '70%'
...
#| fig-alt: "Color palette set manually using hex notation."
#| fig-width: 8
#| fig-height: 6
#| out-width: '70%'
...
<caption>Table 1<br/>Built-in palettes in `{ggplot2}`.</caption>
 <thead>
  <tr>
   <th style="text-align:left; width:30%;" id="fill">Fill Scale</th>
   <th style="text-align:left; width: 30%;" id="color">Color Scale</th>
   <th style="text-align:left; width: 40%;" id="desc">Description</th>
  </tr>
 </thead>
<tbody>
  <tr style="border-bottom: 1px solid black;">
   <td style="text-align:left;" headers="fill"> `scale_fill_hue()` </td>
   <td style="text-align:left;" headers="color"> `scale_color_hue()` </td>
   <td style="text-align:left;" headers="desc"> Colors evenly spaced around the color wheel </td>
  </tr>
  <tr style="border-bottom: 1px solid black;">
   <td style="text-align:left;" headers="fill"> `scale_fill_grey()` </td>
   <td style="text-align:left;" headers="color"> `scale_color_grey()` </td>
   <td style="text-align:left;" headers="desc"> Grey scale palette </td>
  </tr>
  <tr style="border-bottom: 1px solid black;">
   <td style="text-align:left;" headers="fill"> `scale_fill_brewer()` </td>
   <td style="text-align:left;" headers="color"> `scale_color_brewer()` </td>
   <td style="text-align:left;" headers="desc"> ColorBrewer palettes </td>
  </tr>
</tbody>
</table>
...
#| fig-alt: "Greyscale color palette good for black-and-white printing."
#| fig-width: 8
#| fig-height: 6
#| out-width: '60%'
...
```{r}
#| label: fig-brewer
#| fig-cap: "Brewer color palettes"
#| fig-alt: "Brewer color palettes"
#| echo: false
...
#| fig-alt: "Set1 qualitative color palette from the Brewer color palette."
#| fig-width: 8
#| fig-height: 6
#| out-width: '60%'
...
#| fig-alt: "FiveThirtyEight color palette from the `{ggthemes}` package."
...
```{r}
#| label: fig-wesanderson
#| fig-cap: "BottleRocket2 color palette from the `{wesanderson}` package."
#| fig-alt: "BottleRocket2 color palette from the `{wesanderson}` package."
#| code-fold: true
#| fig-width: 8
#| fig-height: 6
#| fig-show: hold
...
#| fig-alt: "Acadia color palette from the `{nationalparks}` package."
#| code-fold: true
#| fig-width: 8
#| fig-height: 6
#| fig-show: hold
...
#| fig-alt: "Using the `theme_minimal()` layer to update the look of the plot."
#| fig-width: 8
#| fig-height: 6
#| out-width: '60%'
...
#| fig-alt: "Using the `theme_wsj()` layer from the `{ggthemes}` package to update the look of the plot to look like plots in the Wall Street Journal."
#| fig-width: 8
#| fig-height: 6
#| out-width: '60%'
...
#| fig-alt: "You can customize almost any part of the theme using the `theme()` layer. In this plot we changed the font face and color on the axes labels."
#| fig-width: 8
#| fig-height: 6
#| out-width: '60%'
...
#| fig-alt: "You can also create your own theme to use with any plot."
#| fig-width: 8
#| fig-height: 6
#| out-width: '60%'
...
#| fig-cap: "Extensions are available at the ggplot2 extensions website."
#| fig-alt: "Extensions are available at the ggplot2 extensions website."
#| echo: false
...
#| fig-alt: "The `{scales}` package helps format labels on the axes. Here we have used it to add a dollar sign in front of labels on the x-axis."
#| fig-width: 8
#| fig-height: 6
#| out-width: '60%'
