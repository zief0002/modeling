...
tab_01 %>%
  ...
  kable(
    format = "html",
    caption = "Correlations between three student attributes. Means (standard deviations) are displayed on the main diagonal.",
...
data.frame(
  ...
  kable(
    format = "html",
    caption = "Predicted average GPA for students who spend 1, 2, and 3 hours a week on homework with parent education level of 12 years.",
...
data.frame(
  ...
  kable(
    format = "html",
    caption = "Predicted average GPA for students who spend 1, 2, and 3 hours a week on homework with parent education level of 13 years.",
    col.names = c("Homework", "Parent Education", "Model Predicted GPA"),
    align = c("c", "c", "c"),
    table.attr = "style='width:60%;'"
  ) %>%
...
```{r out.width='60%', fig.align='center', fig.cap="Model predicted GPA as a function of time spent on homework for students with a parent education level of 8 years (blue, dot-dashed line), 12 years (orange, solid line), and 16 years (red, dashed line)."}
...
data.frame(
  ...
  kable(
    format = "html",
    caption = "Predicted GPA for students who spend six hours a week on homework with 8, 12, and 16 years of parent education.",
    col.names = c("Homework", "Parent Education", "Model Predicted GPA"),
    align = c("c", "c", "c"),
    table.attr = "style='width:60%;'"
  ) %>%
...
data.frame(
  ...
  kable(
    format = "html",
    caption = "Predicted GPA for students who spend six hours a week on homework with with parent education of 8, 9, and 10 years",
    col.names = c("Homework", "Parent Education", "Model Predicted GPA"),
    align = c("c", "c", "c"),
    table.attr = "style='width:60%;'"
  ) %>%
...
```{r fig.width=12, fig.height=4, out.width='90%', fig.cap="Model predicted GPA as a function of time spent on homework for students with a parent education level of 8, 12, and 16 years."}
# Load package
library(patchwork)
...
```{r fig.width=12, fig.height=4, out.width='90%', fig.cap="Model predicted GPA as a function of parent education level for students who spend 2 hours, 5 hours, and 10 hours a week on homework."}
# Create plot 1
...
```{r fig.cap="Model predicted GPA as a function of time spent on homework for students with an average parent education level (14.03 years)."}
ggplot(data = keith, aes(x = homework, y = gpa)) +
 geom_point(alpha = 0) +
