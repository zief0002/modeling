# Assumptions Underlying the Regression Model {#assumptions}
...
#| fig-alt: "A visual depiction of *X*- and *Y*-values and regression line from a population in which the distributional assumptions are valid."
#| echo: false
...
#| fig-alt: "A visual depiction of the simple regression model's assumptions about the residuals."
#| echo: false
...
p1 = ggplot(data = d, aes(x = x, y = y2)) +
  geom_point() +
  theme_bw() +
  stat_function(
    fun = function(x) {10 + 23.4*x}, 
    color = "#c62f4b", 
    linetype = "solid" 
    ) +
  xlim(0, 11) +
  ylim(-30, 300) +
  ggtitle("Correctly specified linear function")


# Misspecified model
p2 = ggplot(data = d, aes(x = x, y = y1)) +
  geom_point() +
  theme_bw() +
  stat_function(
...
#| fig-cap: "The left-hand plot shows the residuals from the correctly specified linear model versus the *X*-values. The right-hand plot shows the residuals from the mis-specified linear model versus the *X*-values. A reference line at $Y=0$ has also been added to the plot to aid interpretation."
#| fig-alt: "The left-hand plot shows the residuals from the correctly specified linear model versus the *X*-values. The right-hand plot shows the residuals from the mis-specified linear model versus the *X*-values. A reference line at $Y=0$ has also been added to the plot to aid interpretation."
#| fig-width: 8
#| fig-height: 4
#| out-width: "100%"
#| echo: false
...
#| fig-alt: "The left-hand plot shows conditional distributions of normally distributed residuals. The right-hand plot shows conditional distributions that are not normally distributed. The line $Y=0$ has also been included to aid interpretation."
#| fig-width: 8
#| fig-height: 4
#| out-width: "100%"
#| echo: false
...
#| fig-alt: "The left-hand plot shows conditional distributions of normally distributed residuals with equal variances. The center plot shows conditional distributions that are not normally distributed but still have equal variances. The right-hand plot shows conditional distributions that are normally distributed but have unequal variances. The line $Y=0$ has also been included in all plots to aid interpretation."
#| fig-width: 12
#| fig-height: 4
#| out-width: "100%"
#| echo: false
...
#| fig-alt: "LEFT: Density plot of the marginal distribution of residuals from the fitted regression model. RIGHT: Scatterplot of the residuals versus time spent on homework. The $Y=0$ line has been included as a reference for interpretation."
#| fig-width: 8
#| fig-height: 4
#| out-width: "100%"
...
#| fig-alt: "LEFT: Density plot of the marginal distribution of standardized residuals from the fitted regression model. RIGHT: Scatterplot of the standardized residuals versus time spent on homework. The $Y=0$ line has been included as a reference for interpretation."
#| fig-width: 8
#| fig-height: 4
#| out-width: "100%"
# Density plot of the residuals
...
## Using the Fitted Values Rather than X in the Scatterplot
...
```{r}
#| label: fig-std-residuals-fitted-emp
#| fig-cap: "Scatterplot of the standardized residuals versus the fitted values. The $Y=0$ line has been included as a reference for interpretation."
#| fig-alt: "Scatterplot of the standardized residuals versus the fitted values. The $Y=0$ line has been included as a reference for interpretation."
#| out-width: "70%"
...
#| fig-alt: "Density plot of the marginal distribution of standardized residuals from the fitted regression model (raspberry, solid line). The density for a ~N(0,1) distribution (black, dashed line) has been included as a comparative reference."
...
#| fig-alt: "The density for a ~N(0,1) distribution (black, dashed line) and the sampling uncertainty associated with that normal distribution (blue shaded area)."
#| echo: false
# Load library
library(educate)
...
#| fig-alt: "Density plot of the marginal distribution of standardized residuals from the fitted regression model (raspberry line). The sampling uncertainty associated with the normal distribution is also displayed (blue shaded area)."
# Load library
library(educate)
...
#| fig-cap: "Scatterplot of the standardized residuals versus the fitted values from a regression model using time spent on homework to predict GPA. A horizontal line at $Y=0$ shows the expected mean residual under the linearity assumption."
#| fig-alt: "Scatterplot of the standardized residuals versus the fitted values from a regression model using time spent on homework to predict GPA. A horizontal line at $Y=0$ shows the expected mean residual under the linearity assumption."
ggplot(data = aug_a, aes(x = .fitted, y = .std.resid)) +
  geom_point() +
...
#| fig-cap: "Scatterplot of the standardized residuals versus the fitted values from a regression model using time spent on homework to predict GPA. The values plotted indicate the students' row numbers in the data. Horizontal lines at $Y={-2, 0, +2}$ are included to aid interpretation."
#| fig-alt: "Scatterplot of the standardized residuals versus the fitted values from a regression model using time spent on homework to predict GPA. The values plotted indicate the students' row numbers in the data. Horizontal lines at $Y={-2, 0, +2}$ are included to aid interpretation."
