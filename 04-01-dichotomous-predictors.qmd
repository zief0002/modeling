...
#| fig-cap: "Coefficient plot for three models regressing six-year graduation rates on educational sector. Uncertainty based on the 95% confidence intervals is displayed. (The intercept is not displayed.)"
#| fig-width: 9
#| fig-height: 3
#| out-width: "90%"
# Load library
...
#| fig-cap: "Predicted graduation rate as a function of median SAT scores for public (orange, solid line) and private (blue, dashed line) institutions in Minnesota. Tuition rate is controlled by fixing the value to the marginal average tuition value."
#| fig-width: 8
#| fig-height: 6
#| out-width: "60%"
