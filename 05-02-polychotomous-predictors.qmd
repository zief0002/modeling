...
#| fig-alt: "LEFT: Density plot of news knowledge. RIGHT: Bar plot of news source."
#| fig-width: 8
#| fig-height: 4
#| out-width: "100%"
...
$$
\begin{split}
\hat{\mathrm{Knowledge}_i} = &-27.80 + 0.19(\mathrm{Age}_i) + 3.24(\mathrm{Education}_i) + 0.23(\mathrm{News~Consumption}_i) + \\
& 0.23(\mathrm{Engagement}_i) + 7.87(\mathrm{Com}_i) + 0.08(\mathrm{Con}_i) +  5.96(\mathrm{Lib}_i)
\end{split}
$$
