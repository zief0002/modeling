...
library(stargazer)
stargazer(lm.3, lm.5, lm.6, dep.var.labels = "Six-year graduation rate", covariate.labels = c("Median SAT score", "Tuition", "Educational Sector"), keep.stat = c("rsq", "ser", "f"), notes = "Educational Sector: 0 = Private; 1 = Public", notes.align = "l", notes.append = TRUE, header = FALSE, type="html")
```
