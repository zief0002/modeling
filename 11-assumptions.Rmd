...
```{r out.width='50%', fig.cap="A visual depiction of *X*- and *Y*-values and regression line from a population in which the distributional assumptions are valid.", echo=FALSE}
...
```{r out.width='50%', fig.cap="A visual depiction of the simple regression model's assumptions about the residuals.", echo=FALSE}
...
```{r fig.width=8, fig.height=4, out.width="90%", fig.cap="The left-hand plot shows the residuals from the true nonlinear model versus the *X*-values. The right-hand plot shows the residuals from the mis-specified linear model versus the *X*-values. A reference line at $Y=0$ has also been added to the plot to aid interpretation.", echo=FALSE}
...
```{r fig.width=8, fig.height=4, out.width="90%", fig.cap="The left-hand plot shows conditional distributions of normally distributed residuals. The right-hand plot shows conditional distributions that are not normally distributed. The line $Y=0$ has also been included to aid interpretation.", echo=FALSE, cache=TRUE}
...
```{r fig.width=12, fig.height=4, out.width="99%", fig.cap="The left-hand plot shows conditional distributions of normally distributed residuals with equal variances. The center plot shows conditional distributions that are not normally distributed but still have equal variances. The right-hand plot shows conditional distributions that are normally distributed but have unequal variances. The line $Y=0$ has also been included in all plots to aid interpretation.", echo=FALSE, cache=TRUE}
# Simulate data
set.seed(100)
x = round(runif(n = 1000, min = 0, max = 10), 0) + rnorm(n=50, mean = 0, sd = 0.5)
e1 = rnorm(n = 1000, mean = 1, sd = 20)
...
```{r out.width="45%%", fig.cap="LEFT: Density plot of the marginal distribution of residuals from the fitted regression model. RIGHT: Scatterplot of the residuals versus time spent on homework. The $Y=0$ line has been included as a reference for interpretation.", fig.show='hold'}
...
```{r out.width="45%%", fig.cap="LEFT: Density plot of the marginal distribution of standardized residuals from the fitted regression model. RIGHT: Scatterplot of the standardized residuals versus time spent on homework. The $Y=0$ line has been included as a reference for interpretation.", fig.show='hold'}
# Density plot of the residuals
...
```{r out.width='60%', fig.cap="A visual depiction of the multiple regression model's assumptions.", echo=FALSE}
include_graphics("figs/notes-11-multiple-regression-assumptions.png")
```
...
```{r out.width='45%', fig.show='hold', fig.cap="LEFT: Density plot of the marginal distribution of standardized residuals from the fitted regression model. RIGHT: Scatterplot of the standardized residuals versus time spent on homework. The $Y=0$, $Y=-2$ and $Y=2$ lines have been included as a references for interpretation."}
...
```{r fig.cap="Density plot of the marginal distribution of standardized residuals from the fitted regression model (raspberry, solid line). The density for a ~N(0,1) distribution (black, dashed line) have been included as a comparative reference."}
# Density plot of the standardized residuals
ggplot(data = aug_2, aes(x = .std.resid)) +
  stat_density(geom = "line", color = "#c62f4b") +
...
```{r echo=FALSE, fig.cap="The density for a ~N(0,1) distribution (black, dashed line) and the sampling uncertainty associated with that normal distribution (blue shaded area)."}
# Load library
library(educate)
...
```{r fig.cap="Density plot of the marginal distribution of standardized residuals from the fitted regression model (raspberry line). The sampling uncertainty associated with the normal distribution is also displayed (blue shaded area)."}
# Load library
library(educate)
...
```{r fig.cap="Scatterplot of the standardized residuals versus the fitted values from a regression model using time spent on homework and parent education level to predict GPA. The values plotted indicate the students' row numbers in the data. A horizontal line at $Y=0$ is included to aid interpretation."}
